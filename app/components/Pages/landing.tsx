              ...
              <div className="bg-white rounded-2xl shadow-2xl p-8">
                <div className="border-2 border-gray-100 rounded-xl p-6 bg-gradient-to-br from-white to-blue-50/30">
                  <div className="flex items-start justify-between mb-5">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">⭐ 4.9 • 127 rides</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                    <span className="text-sm text-gray-600 font-medium">Departs in 5 min</span>
      ...
      <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 border border-gray-100">
              <div className="w-14 h-14 bg-gradient-to-br from-pink-500 to-pink-400 rounded-xl flex items-center justify-center mb-6">
                <svg className="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-gray-600 leading-relaxed">
                Build trust through ratings and feedback. Recognize outstanding community members.
              </p>
            </div>
          </div>
        </div>
